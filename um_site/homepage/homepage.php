            ...
            <div class="card">
                <div class="row">
                    ...
                    <div class="col text-end card-right-col">
                        ...
                        <h3 style="font-weight: bold" class=" card-title card-time"><?php echo date("h:i A", strtotime($event_info['date'])); ?></h3>
                    </div>
                </div>
            </div>
            <?php endforeach; ?>
        ...
        <div class="col">
            ...
            <div class="card">
                <div class="row">
                    ...
                    <div class="col text-end card-right-col">
                        <h3 class="card-time card-title text-right"><?php echo strtoupper($club_info['privilege'])?>
                        </h3>
                    </div>
                </div>
            </div>
