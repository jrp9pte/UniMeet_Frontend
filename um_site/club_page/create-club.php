        ...
        <div class="col">
            ...
            <form class="search-bar" action="./create-club-process.php" method="post">
                <div class="form-group mb-3">
                    ...
                    <input type="text" class="mt-2 form-control" id="club-name" name="club-name"
                        aria-describedby="clubHelp" placeholder="Enter club name..." required>
                </div>
                <div class="form-group mb-3">
                ...
                <button type="submit" name="create-club-button" value="Create" class="btn btn-primary">Create
                    Club</button>
            </form>
        </div>
    </div>
